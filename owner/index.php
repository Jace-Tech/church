            ...
            <div class="c52db c3ff8">
                ...
                <div class="flex cbz56 cfwm1 chmlm crszu">
                    ...
                    <div class="ciiqv cofxq c3ff8 c9r0z c0ycj">
                        ...
                        <h1 class="text-3xl text-slate-800 dark:text-slate-100 font-bold crkc7">Welcome back! ✨</h1>
                        <!-- Form -->
                        <form action="./handlers/auth_handler.php" method="POST">
                            <div class="cxebx">
                                <div>
                                    <label class="block text-sm cw92y ci4cg" for="email">Email Address</label>
                                    <input id="email" class="c03gb c3ff8" type="email" name="email">
                                </div>
                                <div>
                                    <label class="block text-sm cw92y ci4cg" for="password">Password</label>
                                    <input id="password" class="c03gb c3ff8" type="password" name="password" autocomplete="on">
                                </div>
                            </div>
                            <div class="flex items-center cmgwo cro1p">
                                <!-- <div class="mr-1">
                                    <a class="text-sm ck3o7 cn69j" href="reset-password.html">Forgot Password?</a>
                                </div> -->
                                <!-- <button class="btn ml-3 cfeqx cf1ce ceqwg" name="login">Sign In</button> -->
                                <button class="btn cfeqx cf1ce ceqwg" name="login">Sign In</button>
                            </div>
                        </form>
                        <!-- Footer -->
                        <div class="border-slate-200 dark:border-slate-700 c87xd cro1p cc5dk">
                            <div class="text-sm">
                                Don’t you have an account? <a class="text-indigo-500 cuv1l cdi3j cw92y" href="./signup">Sign Up</a>
                            </div>
                            <!-- Warning -->
                            <div class="cggtb"></div>
                        </div>
