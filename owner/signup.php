<?php require_once("../addons/guest.php"); ?>
<?php  
    ...
    $exists = getAllAdmins($connect);
    if(count($exists)) redirect("./");
...
<body class="dark:text-slate-400 c3jt4 c6w4h c6vqo c0ndv csf1w">
            ...
            <div class="c52db c3ff8">
                ...
                <div class="flex cbz56 cfwm1 chmlm crszu">
                    ...
                    <div class="ciiqv cofxq c3ff8 c9r0z c0ycj">
                        ...
                        <h1 class="text-3xl text-slate-800 dark:text-slate-100 font-bold crkc7">Create your Account ✨</h1>
                        <!-- Form -->
                        <form action="./handlers/auth_handler.php" method="POST">
                            <div class="cxebx">
                                <div>
                                    <label class="block text-sm cw92y ci4cg" for="email">Email Address <span class="c6tg6">*</span></label>
                                    <input id="email" class="c03gb c3ff8" type="email" name="email">
                                </div>
                                <div>
                                    <label class="block text-sm cw92y ci4cg" for="name">Username <span class="c6tg6">*</span></label>
                                    <input id="name" class="c03gb c3ff8" type="text" name="username">
                                </div>
                            ...
                            <div class="flex items-center cmgwo cro1p">
                                <button name="register" class="btn cfeqx c626f cf1ce ceqwg">Sign Up</button>
                            </div>
                        </form>
                        <!-- Footer -->
                        <div class="border-slate-200 dark:border-slate-700 c87xd cro1p cc5dk">
                            <div class="text-sm">
                                Have an account? <a class="text-indigo-500 cuv1l cdi3j cw92y" href="./">Sign In</a>
                            </div>
                        </div>
    ...
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317" integrity="sha512-euoFGowhlaLqXsPWQ48qSkBSCFs3DPRyiwVu3FjR96cMPx+Fr+gpWRhIafcHwqwCqWS42RZhIudOvEI+Ckf6MA==" data-cf-beacon='{"rayId":"871d5934bbfb95f5","r":1,"version":"2024.3.0","token":"59cc17d45d734f9ba118c63036ab1b84"}' crossorigin="anonymous"></script>
</body>
