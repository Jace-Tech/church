...
<html lang="en">
<!-- Mirrored from winsfolio.net/blesso/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2024 10:15:52 GMT -->
...
<head>
  ...
  <!-- Title -->
  <title>About - <?= $_ENV['APP_NAME'] ?></title>
  <!-- Favicon -->
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          <div class="content">
            ...
            <p class="w-85">
              ...
              adipisicing elit ipsa quae ab illo invene ipsa
              quae ab ille ab illo inventor sed totam rem ape
              eaque ipsa quae ab illo invene ipsa ae ab ille
              ab illo inventore.
            </p>
            ...
            <div class="sidetwo">
              <div class="contacts">
                <span class="icon">
                  <svg version="1.1" id="cclsdfock" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 559.98 559.98" style="
                                                enable-background: new 0 0
                                                    559.98 559.98;
                                            " xml:space="preserve">
                    <g>
                      <g>
                        <path d="M279.99,0C125.601,0,0,125.601,0,279.99c0,154.39,125.601,279.99,279.99,279.99c154.39,0,279.99-125.601,279.99-279.99 C559.98,125.601,434.38,0,279.99,0z M279.99,498.78c-120.644,0-218.79-98.146-218.79-218.79 c0-120.638,98.146-218.79,218.79-218.79s218.79,98.152,218.79,218.79C498.78,400.634,400.634,498.78,279.99,498.78z"></path>
                        <path d="M304.226,280.326V162.976c0-13.103-10.618-23.721-23.716-23.721c-13.102,0-23.721,10.618-23.721,23.721v124.928 c0,0.373,0.092,0.723,0.11,1.096c-0.312,6.45,1.91,12.999,6.836,17.926l88.343,88.336c9.266,9.266,24.284,9.266,33.543,0 c9.26-9.266,9.266-24.284,0-33.544L304.226,280.326z"></path>
                      </g>
                    </g>
                    <g></g>
                    <g></g>
                ...
                <ul>
                  <li>
                    <p>We are now meeting online!</p>
                  </li>

                  <li>
                    <p class="theme-clr">
                      Every Sunday @ 11:30am via Zoom.
                    </p>
                  </li>
                </ul>
              </div>
              ...
              <div class="contacts">
                <span class="icon">
                  <svg version="1.1" id="map-pin" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="
                ...
                <ul>
                  <li>
                    <p>
                      ...
                      College Jerningham Road London,
                    </p>
                  </li>
                </ul>
              </div>
        ...
        <div class="col-lg-6 col-md-12 col-sm-12">
          <div class="content services-online">
            ...
            <div class="sidetwo">
              <div class="contacts">
                <span class="icon">
                  <svg version="1.1" id="church-svg-about-page" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 456.16 456.16" style="
                                                enable-background: new 0 0
                                                    456.16 456.16;
                                            " xml:space="preserve">
                    <g>
                ...
                <ul>
                  ...
                  <li>
                    <p>
                      il odio amet nibh vulpuate
                      cursus laccumsan ipsuy vel ibh
                      vulpuatet nibh.
                    </p>
                  </li>
                </ul>
              ...
              <div class="contacts">
                <span class="icon">
                  <svg id="donation-box" enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                    <g>
      ...
      <div class="row">
        <div class="pray-data text-center">
          ...
          <h2 class="m-auto text-white">
            “Among those who went to the Temple to worship were
            people who came saying “Sir, we would like to see
            Jesus”
          </h2>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <div class="c-slider">
            <div>
              <h2 class="font-bold">
                Decisions Based on Church Reviews1
              </h2>

              <p>
                “ I moved to Quincy last year and was
                searching for a church home. The people here
                are always smiling and friendly. Pastor
                Taylor is kind and always positive. I've
                been going to this church for almost a year
                now and I look forward to going each Sunday.
                ”
              </p>

              <ul>
                <li>
                  <h3 class="font-bold">Lataya Carter</h3>
                </li>

                <li class="d-flex font-bold">
                  recommends<span class="theme-clr">blesso Church</span>
                </li>
              </ul>
            </div>
            ...
            <div>
              <h2 class="font-bold">
                Based on Church Decisions Reviews2
              </h2>

              <p>
                “ Lorem ipsum dolor sit amet, consectetur
                adipiscing elit. Morbi convallis nec magna
                in imperdiet. Morbi condimentum, justo nec
                posuere dictum, velit nisl rhoncus urna,
                pretium ultricies neque ante sit amet
                turpis. Cras malesuada. ”
              </p>

              <ul>
                <li>
                  <h3 class="font-bold">William</h3>
                </li>
            ...
            <div>
              <h2 class="font-bold">
                Church Decisions Based on Reviews3
              </h2>
            ...
            <div>
              <h2 class="font-bold">
                On Church Decisions Based Reviews4
              </h2>

              <p>
                “ c dictum, ex et porttitor sagittis, lorem
                turpis pharetra augue, vel maximus enim dui
                id dui. Praesent fermentum dapibus elit,
                gravida elementum sapien accumsan sed. Sed
                pretium quis eros fermentum placerat. Donec
                imperdiet sceler ”
              </p>

              <ul>
                <li>
                  <h3 class="font-bold">Julee</h3>
                </li>
...
<!-- Mirrored from winsfolio.net/blesso/about-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Mar 2024 10:15:54 GMT -->
